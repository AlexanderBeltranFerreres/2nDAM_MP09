        ...
        <table class="min-w-full mt-4 bg-white border border-gray-300">
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-center">
                    <a href="/edit/<?= $film['id'] ?>" class="text-blue-500 hover:text-blue-700 mr-3">Edit</a>
                    <a href="/delete/<?= $film['id'] ?>" class="text-red-500 hover:text-red-700 mr-3">Delete</a>
                    <a href="/info_films/<?= $film['id'] ?>" class="text-pink-500 hover:text-red-700 ">Info</a>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php endif; ?>
