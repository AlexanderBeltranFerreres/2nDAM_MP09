    ...
    <div class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <form action="/update" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <div id="genreDropdown" class="border border-gray-300 rounded-md p-2 w-full cursor-pointer" onclick="toggleDropdown()">
                        <span id="displayGenres" <?= htmlspecialchars($film->genere) ?> class="text-gray-700"> <?= htmlspecialchars($film->genere) ?> </span>
                    </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="sinopsis" required class="mt-1 block w-full border border-gray-300 rounded-md p-2 h-32"><?= htmlspecialchars($film->sinopsis) ?></textarea>
            </div>
            <div class="mb-4">
